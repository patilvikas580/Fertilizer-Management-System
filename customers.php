  ...
  <div class="col-12">
    ...
    <div class="table-responsive mt-2">
      <table class="table table-bordered table-striped text-center">
        ...
        <tr>
          <td colspan="12">
            <h4 class="text-center text-white m-0">! ! !  Customers ! ! !</h4>
          </td>
        </tr>
        <tr>
      ...
      <tbody>
        <?php 
         ...
         ?>
         <tr>
           <td class="text-white"><?= $row['cid'] ?></td>     
           <td class="text-white"><?= $row['name'] ?></td>     
           <td class="text-white"><?= $row['mobile'] ?></td> 
           <td class="text-white"><?= $row['address'] ?></td>   
           <td class="text-white"><a href="editcustomers.php?cid=<?= $row['cid'] ?>" class="text-white"> <i class="fas fa-edit"></i> Edit</a> |&nbsp;&nbsp;<i class="fas fa-trash"></i> <a href="deletecustomers.php?cid=<?= $row['cid'] ?>" class="text-white">Delete</a></td>                                                        
